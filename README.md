...
## Credits/Assets used
Some of the code is based on Acerola's Post Processing effect for Unity's Built In pipeline, but has since been adapted to work on Unity 6 and modified for preformance improvements, etc. 
